  ...
  return (
    <div className="space-y-8">
      <header>
        ...
        <p className="text-muted-foreground mt-2">Relatórios e análise de desempenho.</p>
      </header>
      <Card className="p-10 flex flex-col items-center gap-4 text-center">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            O módulo de Relatórios está a ser desenvolvido e estará disponível em breve.
          </p>
        </div>
      </Card>
    </div>
